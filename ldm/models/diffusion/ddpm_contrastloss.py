...
class LatentDiffusion(DDPM):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        weighted_contrastloss = self.contrast_weight * torch.stack(contrastloss, axis=0).mean()  
        loss_dict.update({f'{prefix}/loss_contrastive': weighted_contrastloss})
        loss += weighted_contrastloss # contrastive loss added
